...
import { navBar, mainBody, about, repos, leadership, skills, getInTouch, experiences } from './editable-stuff/config.js';
...
const Home = React.forwardRef((props, ref) => {
  return (
    <>
      ...
      {repos.show && <Project heading={repos.heading} username={repos.gitHubUsername} length={repos.reposLength} specfic={repos.specificRepos} />}
